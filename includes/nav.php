                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <?php
                                if ($activePage=="electronics")echo active;
                            ?>" id="navbarDropdown" href="//phonesales.ie/electronics" role="button" data-bs-toggle="dropdown" aria-expanded="false">Electronics</a>
